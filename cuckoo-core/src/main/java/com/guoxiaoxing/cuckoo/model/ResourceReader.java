...
public abstract class ResourceReader implements ResourceIds {
    ...
    private static void readClassIds(Class<?> platformIdClass, String namespace,
        ...
        try {
            ...
            LogUtils.i(TAG, "Can't read built-in id names from " + platformIdClass.getName(), e);
        }
    }
    ...
    protected void setup() {
        ...
        try {
            ...
            LogUtils.i(TAG, "Can't load names for Android view ids from '" + localClassName
            ...
            LogUtils.i(TAG,
                    "You may be missing a Resources class for your package due to your proguard configuration, "
                            ...
                            + " resources class:\n\n"
                            + "<meta-data android:name=\"com.guoxiaoxing.cuckoo.android.ResourcePackageName\""
