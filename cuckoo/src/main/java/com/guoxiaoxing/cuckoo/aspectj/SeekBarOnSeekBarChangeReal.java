...
public class SeekBarOnSeekBarChangeReal {
    private final static String TAG = "SeekBarOnSeekBarChangeReal";
    ...
    public static void onAppClick(JoinPoint joinPoint) {
        try {
            ...
            properties.put(AspectjConstants.ELEMENT_TYPE, "SeekBar");

            //Content
            properties.put(AspectjConstants.ELEMENT_CONTENT, String.valueOf(seekBar.getProgress()));

            //fragmentName
            ViewUtils.getFragmentNameFromView(seekBar, properties);
            ...
            e.printStackTrace();
            LogUtils.i(TAG, " AOP ERROR: " + e.getMessage());
        }
    }
}
