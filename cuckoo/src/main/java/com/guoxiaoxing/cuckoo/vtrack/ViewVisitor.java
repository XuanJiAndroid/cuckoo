...
import com.guoxiaoxing.cuckoo.event.EventInfo;
...
public abstract class ViewVisitor implements ViewPathFinder.Accumulator {

    private final List<ViewPathFinder.PathElement> mPath;
    private final ViewPathFinder mViewPathFinder;

    private static final String TAG = "SA.ViewVisitor";

    public void visit(View rootView) {
        mViewPathFinder.findTargetsInRoot(rootView, mPath, this);
    }
    ...
    protected ViewVisitor(List<ViewPathFinder.PathElement> path) {
        mPath = path;
        mViewPathFinder = new ViewPathFinder();
    }
    ...
    private static abstract class EventTriggeringVisitor extends ViewVisitor {
        ...
        public EventTriggeringVisitor(List<ViewPathFinder.PathElement> path, EventInfo eventInfo,
    ...
    public static class AddAccessibilityEventVisitor extends EventTriggeringVisitor {
        ...
        public AddAccessibilityEventVisitor(List<ViewPathFinder.PathElement> path,
        ...
        public void accumulate(View found) {
            ...
            LogUtils.i(TAG, String.format("ClickVisitor accumulated. View %s", found.toString()));
        ...
        private View.AccessibilityDelegate getOldDelegate(View v) {
            ...
            try {
                ...
                LogUtils.i(TAG, "getAccessibilityDelegate threw an exception when called.", e);
            }
    ...
    public static class AddTextChangeListener extends EventTriggeringVisitor {
        public AddTextChangeListener(List<ViewPathFinder.PathElement> path, EventInfo eventInfo,
    ...
    public static class ViewDetectorVisitor extends EventTriggeringVisitor {
        public ViewDetectorVisitor(List<ViewPathFinder.PathElement> path, EventInfo eventInfo,
                                   OnEventListener listener) {
            super(path, eventInfo, listener, false);
            mSeen = false;
        }
